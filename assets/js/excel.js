$.get("./assets/php/listado.php", (data) => {
  ...
  for (const item of data) {
    const element = `<div class="product-item">
    <div class="product-item__thumb">
            <a href="detail.html?id=${item.id}">
                <img class="thumb-primary" src="./assets/productos/${item.id}.jpg" alt="Product" />
                <img class="thumb-secondary" src="./assets/productos/${item.id}.jpg" alt="Product" />
            </a>
        </div>
        <div class="product-item__content mt-3">
    ...
    const fav = `<div class="product-item">
    <div class="product-item__thumb">
            <a href="detail.html?id=${item.id}">
                <img class="thumb-primary" src="./assets/productos/${item.id}.jpg" alt="Product" />
                <img class="thumb-secondary" src="./assets/productos/${item.id}.jpg" alt="Product" />
